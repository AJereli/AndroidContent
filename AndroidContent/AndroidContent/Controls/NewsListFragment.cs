...
namespace AndroidContent
{
    ...
    class ContentUnitAdapter : ArrayAdapter<ContentUnit>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            {
                convertView = activity.LayoutInflater.Inflate(Resource.Layout.unit_list_without_img, null);
                ...
                convertView = activity.LayoutInflater.Inflate(Resource.Layout.unit_list, null);
                int r_id_img = Resource.Id.content_imgImageView;
                ...
                ImageView iv = convertView.FindViewById<ImageView>(r_id_img);
